...
import { ArrowRightOnRectangleIcon, Bars3Icon, ChevronDownIcon, ChevronUpIcon, MoonIcon, SunIcon, UserCircleIcon, XMarkIcon } from '@heroicons/react/24/solid';
...
function Header() {
    ...
    return (
        ...
        <header 
            ...
            <nav className='lg:flex gap-28 hidden items-center'>
                ...
                <div className='flex gap-2 justify-center'>
                    ...
                    <div className='flex justify-center items-center gap-2 relative'>
                        ...
                        {
                            isOpenModalUser &&
                            <p className='absolute bg-skin-ligth py-2 rounded-lg  text-skin-base mt-32 mr-16 justify-center px-2 flex flex-col w-[120px] gap-2 drop-shadow-md'>
                                <span 
                                    className='cursor-pointer flex gap-2 hover:bg-skin-base hover:text-skin-ligth px-1 rounded' 
                                ><UserCircleIcon className='h5 w-5'/>Mi Perfil</span>
                                <span 
                                    onClick={handleClick}
                                    className='cursor-pointer flex gap-1 hover:bg-skin-base hover:text-skin-ligth px-1 rounded'>
                                    {   
                                        darkMode 
                                            ? <span className='w-full flex gap-2'><SunIcon className='h5 w-5 cursor-pointer'/> Ligth</span>
                                            : <span className='w-full flex gap-2'> <MoonIcon  className='h4 w-4 cursor-pointer'/> Dark</span>
                                    } 
                                </span>
                                <span 
                                    className='cursor-pointer flex gap-1 hover:bg-skin-base hover:text-skin-ligth px-1 rounded' 
